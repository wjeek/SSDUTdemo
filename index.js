...
$(function(){
	...
	$('.contain').bgStretcher({
		images: ['images/bg1.png', 'images/bg2.png', 'images/bg3.png', 'images/bg4.png'],
		imageWidth: 2000, 
		imageHeight: 2000,
		slideDirection: 'W',
		slideShowSpeed: 1000,
...
/*
	导航栏JQ代码
*/	
    $('#h1').hover(function () {        $('#h1 ul').toggle();	});	
	$('#h2').hover(function () {        $('#h2 ul').toggle();	});
	$('#h3').hover(function () {        $('#h3 ul').toggle();	});
	$('#h4').hover(function () {        $('#h4 ul').toggle();	});
/*
	新闻栏JQ代码
*/	
	$('#n1').click(function () {        
		...
		$('#newsimg').attr("src","images/news1.png");
		$('#n1').css("color","#FFFFFF");
		$('#n2').css("color","#999999");
		$('#n3').css("color","#999999");
	});	
	$('#n2').click(function () {        
		...
		$('#news3').css("display","none");
		$('#newsimg').attr("src","images/news2.png");
		$('#n2').css("color","#FFFFFF");
		$('#n1').css("color","#999999");
		$('#n3').css("color","#999999");
	});	
	...
	$('#n3').click(function () {        
		...
		$('#newsimg').attr("src","images/news3.png");
		$('#n3').css("color","#FFFFFF");
		$('#n1').css("color","#999999");
		$('#n2').css("color","#999999");
	});	
...
*/	
	...
	$('.navbut').click(function () {
		...
		if(n==1)
		{
		$('#but').attr("src","images/d2.png");
		n=0;
		}
		else{
		$('#but').attr("src","images/d1.png");	
		n=1;
		}
	});	
});
